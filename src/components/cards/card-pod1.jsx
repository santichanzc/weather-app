...
import imageOne from '../../img/podcast-images/pod1.jpg'
  ...
  return (
        <PodcastCard >
          ...
          <Grid item >
                        ...
                        <img alt='podcast one' src={imageOne} width="150" height="150" margin="auto"></img>
                        
                    </Grid>
  
        
            <PodcastCardTitle >Orgullo</PodcastCardTitle>
