...
import imageTwo from '../../img/podcast-images/pod2.jpg'

export default function CardPodcasTwo(props) {
  ...
  return (
        <PodcastCard >
          ...
          <Grid item >
                        <img alt='podcast one' src={imageTwo} width="150" height="150" margin="auto"></img>
                    </Grid>
