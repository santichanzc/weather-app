...
import imageThree from '../../img/podcast-images/pod3.jpg'

export default function CardPodcasThree(props) {
  ...
  return (
        <PodcastCard >
          ...
          <Grid item >
                        <img alt='podcast one' src={imageThree} width="150" height="150" margin="auto"></img>
                    </Grid>
