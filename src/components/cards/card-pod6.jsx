...
import imageSix from '../../img/podcast-images/pod6.jpg'

export default function CardPodcastSix(props) {
  ...
  return (
        <PodcastCard >
          ...
          <Grid item >
                        <img alt='podcast one' src={imageSix} width="150" height="150" margin="auto"></img>
                    </Grid>
